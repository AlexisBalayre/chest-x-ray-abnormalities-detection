...
def parallel_process_dicom_folder(input_folder, csv_path, batch_size=10):
    files = [
...
if __name__ == "__main__":
    ...
    csv_path = "/Volumes/ALEXIS/ai_project_cranfield/dicom_metadata.csv"
    parallel_process_dicom_folder(input_folder, csv_path)
